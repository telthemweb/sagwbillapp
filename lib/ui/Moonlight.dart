...
class Moonlight extends StatefulWidget {
  Moonlight({super.key});

  @override
  _MoonlightState createState() => _MoonlightState();
}

class _MoonlightState extends State<Moonlight> {
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value!.isEmpty) {
                      return "Moonlight Policy Number empty";
                    }
                    return null;
                  },
                  decoration: InputDecoration(
                      ...
                      hintText: "Moonlight Policy Number",
