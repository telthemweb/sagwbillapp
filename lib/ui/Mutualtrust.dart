...
class Mutualtrust extends StatefulWidget {
  Mutualtrust({super.key});

  @override
  _MutualtrustState createState() => _MutualtrustState();
}

class _MutualtrustState extends State<Mutualtrust> {
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value!.isEmpty) {
                      return "First Mutual Policy Number empty";
                    }
                    return null;
                  },
                  decoration: InputDecoration(
                      ...
                      hintText: "First Mutual  Policy Number",
